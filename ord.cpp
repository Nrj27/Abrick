...
int num_customers;
int sentinel=0;
const double UnitPrice1= 60., UnitPrice2= 55,UnitPrice3= 72, UnitPrice4= 80, UnitPrice5= 40;
double AmountofSale1=0, AmountofSale2=0, AmountofSale3=0, AmountofSale4=0, AmountofSale5=0;


cout<<":::::::::::::::::::MENU:::::::::::::::::::\n\n"
     <<"\n Item[1] Panneer Tikka 		    ₹60. <===\n"
     <<"\n Item[2] Ham Burger  		    ₹55. <===\n"
	 <<"\n Item[3] Italian Sandwich	    ₹72. <===\n"
	 <<"\n Item[4] Shrimp Nuggets		    ₹80. <===\n"
	 <<"\n Item[5] Veggie Supreme		    ₹40. <===\n";
...
switch(order)
			{
                ...
                cout<<"\nHow Many Panneer Tikka  Would You Like To Order:\n";
                               cin>>num1;
...
cout<<"\nPanneer Tikka :\t"<<setw(6)<<left<< num1 <<setw(16)<<right<< UnitPrice1 <<setw(20) <<right<< AmountofSale1<<endl;
